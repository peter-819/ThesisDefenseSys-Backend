...
@REM docker build -t schedule_api:v1 -f schedule/cmd/api/Dockerfile .
docker build -t student_rpc:v1 -f student/cmd/rpc/Dockerfile .
@REM docker build -t student_api:v1 -f student/cmd/api/Dockerfile .
